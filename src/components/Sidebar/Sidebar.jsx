...
const Sidebar = ({ category, setCategory }) => {
  ...
  return (
    <div className="fixed left-0 top-[88px] bg-white h-[calc(100vh-88px)] w-[15%] shadow overflow-y-auto">
        ...
        {sideBarFields.map((field) => {
          return (
            ...
            >
              ...
              />
              <h2 className="font-semibold cursor-pointer">{field.name}</h2>
            </div>
          );
        })}
        <hr className="p-0 w-full border-[#e3e2e2] mt-1" />
        <h2 className="font-semibold cursor-pointer">Subscriptions</h2>
